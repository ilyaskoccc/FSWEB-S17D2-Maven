...
public class DeveloperController {
    ...
    public void init() {
        ...
        this.developers.put(1, new JuniorDeveloper(1,"ilyas",1000d));
    }
    ...
    public DeveloperResponse getById(@PathVariable("id") int id) {
        ...
        if(foundDeveloper == null) {
            return new DeveloperResponse(null,HttpStatus.NOT_FOUND.value(), id + " ile search işlemi yapıldığında böyle bir kayıt bulunamadı.");
        }
    ...
    public DeveloperResponse update(@PathVariable("id") int id, @RequestBody Developer developer) {
        ...
        return new DeveloperResponse(newDeveloper, HttpStatus.OK.value(), id + " kayıt numarası ile update başarılı.");
    }
    ...
    public DeveloperResponse delete(@PathVariable("id") int id) {
        ...
        return new DeveloperResponse(removedDeveloper, HttpStatus.NO_CONTENT.value(), id + " kayıt silme başarılı.");
    }
}
